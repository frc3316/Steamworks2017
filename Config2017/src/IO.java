...
public class IO {
	...
	try {
		 ...
		 */
		{
		    putAIOA("CLIMBING_SWITCH", 5); // FAKE

		    putAIOA("INTAKE_SWITCH_1", 0);
		    putAIOA("INTAKE_SWITCH_2", 1);
		    putAIOA("INTAKE_SWITCH_3", 2); // TODO: FAKE!

		    putAIOA("INSTALLER_SWITCH_1", 3);
		    putAIOA("INSTALLER_SWITCH_2", 4);
		}
		 ...
		 */
		{
		    ...
		    putPDPA("CLIMBING_MOTOR_PDP_CHANNEL", 1);
		}
