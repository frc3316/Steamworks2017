...
public class Config {
	...
	private static void initConfig() {
			 ...
			 */
			{
				...
				// BY ENCODERS
				{
					...
					
					{
						...
						// Right
						addToVariables("chassis_DriveDistanceLongRange_PID_RIGHT_KP", 110.0);
						...
						// Left
						addToVariables("chassis_DriveDistanceLongRange_PID_LEFT_KP", 85.0);
		 ...
		 */
		{
			 ...
			 */
			{
				addToVariables("climbing_UpFast_Voltage", 1.0);
